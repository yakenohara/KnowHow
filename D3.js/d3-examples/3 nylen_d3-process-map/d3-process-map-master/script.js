...
function drawGraph() {
    ...
    graph.categoryKeys = d3.keys(graph.categories); //todo keysとは
    ...
    graph.nodeValues = d3.values(graph.data); //todo d3.valuesとは
